...
stock_list=["sh.600066","sz.000002","sz.002415","sh.600031","sz.000895","sh.600926","sh.601888","sh.600276","sz.300033","sz.002352","sz.000596","sh.600660","sh.601009","sh.000001","sh.600036","sz.000651","sz.000333","sz.002821","sz.300347","sh.601012","sh.603195","sh.600779","sz.000858","sh.603719","sh.603882","sz.300326","sh.603259","sz.300015","sh.600585","sz.300750","sz.002594","sh.600129","sz.002142","sz.002812","sh.603087","sz.300285","sz.300529","sh.600380","sz.000001","sh.600009","sh.600519","sh.600900","sz.002410","sh.601318","sh.601336","sz.002475"]
# stock="sh.600585"
#### 登陆系统 ####
lg = bs.login()
...
for stock in stock_list:
    ...
    # send email
bs.logout()
print("买入1: "+str(buy_list1))
print("买入2: "+str(buy_list2))
print("卖出1: "+str(sell_list1))
print("卖出2: " +str(sell_list2))
print("跌破5日线: "+str(short_ma5_list))
print("跌破10日线："+str(short_ma10_list))
print("破破20日线："+str(short_ma20_list))